...
public class PenguinController : MonoBehaviour
{
    ...
    public float rotationSpeed = 180f; // Saniyedeki d�n�� a��s�
    public float rotationSmoothTime = 0.15f; // D�n���n yumu�ama s�resi
    ...
    public Transform visualModel; // Karakterin modelini (grafi�ini) buraya s�r�kle
    public float leanAmount = 15f; // D�n��lerdeki yatma miktar�
    ...
    // Yumu�atma i�in yard�mc� de�i�kenler
    ...
    {
        // 1. D�N�� YUMU�ATMA
        // moveInput.x (-1, 0, 1) de�erini yumu�ak bir h�za �eviriyoruz
        ...
        // 2. G�RSEL YATMA EFEKT� (Lean)
        // E�er visualModel atanm��sa, d�n�� y�n�ne g�re modeli Z ekseninde yat�r�r
        if (visualModel != null)
        {
            float targetLean = -moveInput.x * leanAmount;
            currentLeanAngle = Mathf.Lerp(currentLeanAngle, targetLean, Time.deltaTime * leanSpeed);

            // Modelin mevcut rotasyonunu bozmadan sadece Z (yatma) eksenini de�i�tiriyoruz
